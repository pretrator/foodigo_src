		...
		$ignore = array(
			...
			'error/permission'
                ...
                $data['permissions'] = array(
                    'extension/module/pavothemer/edit',
                    'extension/module/pavothemer/customize',
                    'extension/module/pavothemer/tools',
                    'extension/module/pavothemer/management',
                    'extension/module/pavoblog/posts',
                    'extension/module/pavoblog/post',
                    'extension/module/pavoblog/category',
                    'extension/module/pavoblog/categories',
                    'extension/module/pavoblog/comments',
                    'extension/module/pavoblog/comment',
                    'extension/module/pavoblog/settings'
                );
