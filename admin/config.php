<?php
// HTTP
define('HTTP_SERVER', 'https://foodigo.in/admin/');
define('HTTP_CATALOG', 'https://foodigo.in/');

// HTTPS
define('HTTPS_SERVER', 'https://foodigo.in/admin/');
define('HTTPS_CATALOG', 'https://foodigo.in/');
